namespace Store
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private async void GetAllItems()
        {
            ...
            if (data.Count() > 0)
            {
                data.ForEach(i => this.ViewModel.Add(new ItemViewModel { Id = i.Id, Name=i.Name, Price=i.Price, Quantity=i.Quantity, Measurement = i.Measurement, ImageBytes=i.Image}));
            }
        }
